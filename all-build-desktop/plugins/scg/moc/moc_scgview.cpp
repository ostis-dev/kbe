...
**
** Created: Sun Mar 18 14:49:16 2012
...
static const char qt_meta_stringdata_SCgView[] = {
    ...
    "deleteJustContour()\0changeIdentifier()\0"
    "action\0changeType(QAction*)\0changeContent()\0"
...
void SCgView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 10: _t->changeIdentifier(); break;
        case 11: _t->changeType((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        case 12: _t->changeContent(); break;
        case 13: _t->setContentVisible((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 14: _t->deleteContent(); break;
        case 15: _t->updateSceneRect((*reinterpret_cast< const QRectF(*)>(_a[1]))); break;
        case 16: _t->editModeChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
