...
-----------------------------------------------------------------------------
*/
#ifndef SCGSCENEEVENTHANDLERS_H_
#define SCGSCENEEVENTHANDLERS_H_
...
class SCgSelectModeEventHandler: public SCgEventHandler
{
    Q_OBJECT
public:
    explicit SCgSelectModeEventHandler(SCgScene* parent);

    virtual ~SCgSelectModeEventHandler();
    ...
    /*! Activate select edit mode. Make connections for edit actions at ballon bars
    */
    void activate();
