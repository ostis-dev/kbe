...
SCgLayersPanel::SCgLayersPanel(SCgView *view, QWidget *parent) :
    ...
    mMarker(0)
{
    ...
    Q_ASSERT_X(view != 0,
               "SCgLayersPanel::SCgLayersPanel(QGraphicsScene *scene, QWidget *parent)",
...
bool SCgLayersPanel::eventFilter(QObject* watched, QEvent* event)
{
...
void SCgLayersPanel::updateViewedArea(int val)
{
    Q_UNUSED(val);
...
void SCgLayersPanel::resizeEvent(QResizeEvent *event)
{
    QWidget::resizeEvent(event);
    sceneRectChanged(mView->sceneRect());
}

void SCgLayersPanel::mousePressEvent(QMouseEvent *event)
{
...
void SCgLayersPanel::mouseMoveEvent(QMouseEvent *event)
{
...
void SCgLayersPanel::sceneRectChanged(const QRectF &rect)
{
    setSceneRect(rect);
...
void SCgLayersPanel::drawBackground ( QPainter * painter, const QRectF & rect )
{
    Q_UNUSED(rect);
